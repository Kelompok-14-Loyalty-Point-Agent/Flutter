...
class _DetailRewardScreenState extends State<DetailRewardScreen> {
  ...
  Widget build(BuildContext context) {
    // RedeemVoucherViewModel _redeemVoucherViewModel =
    //     Provider.of<RedeemVoucherViewModel>(context);
    // final userData = Provider.of<CreditDataViewModel>(context, listen: false);
    return ChangeNotifierProvider(
      create: (context) => RedeemVoucherViewModel(),
      child: Scaffold(
        appBar: AppBar(
        ...
        body: Consumer<RedeemVoucherViewModel>(
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child:
                          Text('Detail Reward', style: TextStyleConst.heading2),
                    ),
                          ...
                          child: SizedBox(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                suffixIcon:
                                    CreditDataViewModel().data?.namaIcon,
                              ),
                            ),
                          ),
                        ),
                    ...
                    ButtonCustome(
                      onPressed: () async {
                        final RedeemVoucherViewModel _redeemVoucherViewModel =
                            Provider.of<RedeemVoucherViewModel>(context,
                                listen: false);
                        bool success =
                            await _redeemVoucherViewModel.postRedeemVoucher(
                          phone: _phoneNumberController.text,
                          voucherId: 1,
                          paymentMethod: 'tPoint',
                          price: 10000,
                          point: 300,
                          product: 'Phone Balance',
                          context: context,
                        );
                        ...
                        //   );
                        // } else {
                        //   // Tampilkan pesan kesalahan jika gagal membuat transaksi
                        // }
                      },
